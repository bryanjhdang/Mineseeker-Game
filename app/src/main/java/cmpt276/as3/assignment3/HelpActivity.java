...
/**
 * Help Screen to display game descriptions, authors, and
...
public class HelpActivity extends AppCompatActivity {
    ...
    private void displayGameDescription() {
        TextView gameDescription = findViewById(R.id.descriptionText);
    ...
    private void displayAuthorDescription() {
        TextView gameAuthor = findViewById(R.id.authorText);
    ...
    private void displaySourceDescription() {
        TextView gameSource = findViewById(R.id.sourcesText);
